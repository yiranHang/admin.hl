  ...
  <div class="upload content-box">
    ...
    <div class="card img-box">
      ...
      <el-descriptions title="配置项 📚（其它参数和单图上传组件相同）" :column="1" border>
        <el-descriptions-item label="fileList"> 双向绑定的 fileList 值，使用示例： v-model:file-list="fileList" </el-descriptions-item>
    ...
    <div class="card img-box">
      ...
      <el-descriptions title="配置项 📚" :column="1" border>
        <el-descriptions-item label="imageUrl"> 双向绑定的 imageUrl 值，使用示例： v-model:image-url="avatar" </el-descriptions-item>
        ...
        <el-descriptions-item label="fileType"> 图片类型限制，默认类型为 ["image/jpeg", "image/png", "image/gif"] </el-descriptions-item>
    ...
    <div class="form-box">
      <div class="card">
        <el-alert title="图片上传组件在 form 表单中使用，上传之后成功会自动重新校验" type="warning" effect="dark" :closable="false" class="mb20" />
