...
class Validate {
   ...
   *  @rule 手机号
   */
  checkPhoneNumber(value: any, callback: any) {
    const regexp =
   ...
   * @returns
   */
  checkPassword(value: any, callback: any) {
   ...
   * @returns
   */
  checkCode(value: any, callback: any) {
   ...
   * @returns
   */
  checkName(value: any, callback: any) {
   ...
   * @returns
   */
  checkPath(value: any, callback: any) {
